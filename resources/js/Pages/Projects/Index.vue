        ...
        <table class="table table-hover table-bordered table-striped align-middle text-center" style="min-width: 660px; table-layout: fixed;">
          ...
          <tbody>
            <tr v-for="project in projects.data" :key="project.id">
              ...
              >
                <Link v-if="can('View Project')" :href="route('projects.show', project.id)" class="text-warning me-2">
                  <i class="bi bi-eye me-2"></i>
                </Link>
                <Link v-if="can('Update Project')" :href="route('projects.edit', project.id)" class="text-primary me-3">
